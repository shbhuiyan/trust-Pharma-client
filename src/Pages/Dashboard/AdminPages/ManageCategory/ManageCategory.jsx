...
const ManageCategory = () => {
  ...
  const categorySubmit = async (e) => {
    ...
    axiosSecure.post("/categories", newCategory).then((res) => {
  ...
  const handleCategoryUpdate = async (e) => {
    ...
    axiosSecure
      .put(`/category-update/${category._id}`, updateCategory)
      .then((res) => {
            ...
            {categories.map((category, i) => {
              return (
                <tr key={category._id}>
                  ...
                  <td>
                    <button
                      onClick={() => updateModalOpen(category._id)}
      ...
      <dialog id="my_modal_update" className="modal">
        <div className="modal-box">
          ...
          <section className="py-6 max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-center mb-4">
              Update{" "}
              <span className="text-blue-500">{category?.categoryName}</span>{" "}
              Category
            </h2>
